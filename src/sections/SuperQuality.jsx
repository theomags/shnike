...
const SuperQuality = () => {
  return (
    <section
      id="about-us"
      className="flex justify-between items-cente max-lg:flex-col gap-10 w-full max-container"
    >
      <div>
        ...
        <p className="mt-4 lg:max-w-lg info-text text-lg ">
          Ensuring premium comfort ans style, our meticulously crafted
      ...
      <div className="flex-1 lex justify-center items-center">
        <img
          src={shoe8}
          alt="shoe8"
          width={570}
